...
const WorkingExperience = () => {
    ...
    const { data: profileResponse, isLoading } = useDoctorProfile<WorkingExperienceGroup>(
        doctorID,
        "working_experience"
    );
            ...
            <ScrollView className="flex-1 p-5">
                ...
                {isLoading ? (
                        ...
                        return (
                            ...
                            >
                                ...
                                <View className="flex-1">
                                    <Text className="text-base text-black font-semibold">Association {index + 1}</Text>
                                    <Text className="text-black-400 text-sm mt-0.5">{experience.past_associations}</Text>
                                </View>

                                <View className="">
                                    <Text className="text-primary text-sm font-medium">{experience.career_start}</Text>
                                </View>
                    ...
                    <View className="items-center justify-center mt-10">
                        <Text className="text-black-400">No working experience added yet.</Text>
                    </View>
                )}
