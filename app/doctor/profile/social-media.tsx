...
const SocialMedia = () => {
    ...
    const { data: profileResponse, isLoading } = useDoctorProfile<SocialMediaGroup>(
        doctorID,
        "social_media"
    );
    ...
    return (
        <View className="flex-1 bg-white">
            ...
            <ScrollView className="flex-1 p-5">
                ...
                <Button className="max-w-52 ml-auto" onPress={() => setModalVisible(true)}>Edit Social Media</Button>
                    ...
                    <View className="mt-5 gap-y-5">
                        <View className="border border-black-200 rounded-xl p-4 flex-row gap-x-3">
                            ...
                            <View className="flex-1">
                                <Text className="text-base text-black font-semibold">Facebook</Text>
                        ...
                        <View className="border border-black-200 rounded-xl p-4 flex-row gap-x-3">
                            ...
                            <View className="flex-1">
                                <Text className="text-base text-black font-semibold">LinkedIn</Text>
                                <Text className="text-black-400 text-sm mt-0.5">
                        ...
                        <View className="border border-black-200 rounded-xl p-4 flex-row gap-x-3">
                            ...
                            <View className="flex-1">
                                <Text className="text-base text-black font-semibold">Instagram</Text>
                                <Text className="text-black-400 text-sm mt-0.5">
                        ...
                        <View className="border border-black-200 rounded-xl p-4 flex-row gap-x-3">
                            ...
                            <View className="flex-1">
                                <Text className="text-base text-black font-semibold">Twitter (X)</Text>
                                <Text className="text-black-400 text-sm mt-0.5">
