...
const EducationHistory = () => {
    ...
    const { data: profileResponse, isLoading } = useDoctorProfile<EducationHistoryGroup>(
        doctorID,
        "education_info"
    );
            ...
            <ScrollView className="flex-1 p-5">
                ...
                {isLoading ? (
                        ...
                        return (
                            ...
                            >
                                ...
                                <View className="flex-1">
                                    <Text className="text-base text-black font-semibold">{education.degree}</Text>
                                    <Text className="text-black-400 text-sm mt-0.5">{education.institution}</Text>
                                    <View className="flex-row mt-1">
                                        <Text className="text-primary text-sm">{education.start_date} - </Text>
                                        <Text className="text-primary text-sm">{education.end_date}</Text>
                                    </View>
                                </View>
                    ...
                    <View className="items-center justify-center mt-10">
                        <Text className="text-black-400">No education history added yet.</Text>
                    </View>
                )}
