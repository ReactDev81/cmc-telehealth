...
const PastAppointmentDetail = () => {
  ...
  // API: previous_appointments[].id matches the appointmentId param
  // notes is a plain string; date/time are already formatted
  const appointment =
    data.previous_appointments?.find(
    ...
    <ScrollView className="flex-1 bg-white p-5">
      <View className="pb-20">
        ...
        <ScheduleAppointment
          ...
          booking_type={appointment.consultation_type_label || "N/A"}
          booking_for="Self"
        />
        ...
        {/* Payment detail */}
        <PaymentDetail
          consultation={appointment.fee_amount || "0.00"}
          admin_fee="0.00"
          aditional_discount="-"
          total={appointment.fee_amount || "0.00"}
        />
