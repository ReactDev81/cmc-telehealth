...
const AddNewPrescription = ({ onClose }: { onClose: () => void }) => {
    ...
    const stampOptions = [
        { label: "Global Stamp (Default Stamp with Signature)", value: "only_global" },
        { label: "Department Stamp (With Signature)", value: "only_department" },
        { label: "Both (Global & Department Stamp with Signature)", value: "both" },
    ];
