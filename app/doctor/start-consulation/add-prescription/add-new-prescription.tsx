...
const AddNewPrescription = ({ onClose }: { onClose: () => void }) => {
    ...
    const addPrescription = useAddPrescription(appointmentId as string, token!);
            ...
            medicines: [
                {
                    ...
                    end_date: data.is_ongoing ? null : endDate?.toISOString().split("T")[0],
        ...
        <View className="p-5 bg-white rounded-xl">
            ...
            <MedicineSearchBar
                ...
                onSelectMedicine={(m) => {
                    ...
                    setValue("medication_type", m.type);
            ...
            <Button onPress={handleSubmit(submit)} className="mt-5 flex-row-reverse">
