...
const AboutUs = () => {
    return(
        <ScrollView className="flex-1 bg-white p-5">
            ...
            <Text className="text-base text-black font-medium">Know more about us, we are more than a hospital</Text>

            <View className="mt-5">
                <Text className="text-base text-black font-medium">Who we are?</Text>
            ...
            <View className="mt-5">
                <Text className="text-base text-black font-medium">What we do?</Text>
                <Text className="text-sm leading-6 text-black-400 mt-2.5">
