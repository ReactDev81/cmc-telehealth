  ...
  if (step === 1) {
    return (
      <FormLayout>
        ...
        <Controller
          ...
          render={() => (
            <View className="mt-5">
              ...
              />
              {watchStep1("password") &&
                renderPasswordStrength(watchStep1("password"))}
            </View>
          )}
        />
        ...
        {/* Continue */}
        <Button onPress={handleSubmitStep1(onSubmitStep1)} className="mt-8">
          Continue
        </Button>
    ...
    >
      <View className="flex-1 bg-white px-6">
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Button onPress={handleSubmitStep2(onSubmitStep2)} className="mt-8">
            Continue
          </Button>
