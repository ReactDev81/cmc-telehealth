...
//                 // Invalidate and refetch profile to get fresh data from server
//                 try {
//                     await qc.invalidateQueries(["patient-profile", patientId, "personal_information"]);
//                 } catch (e) { }

//                 // Update UserContext with new name and avatar from fresh profile
//                 const updatedName = `${formData.first_name} ${formData.last_name}`;
...
//                     if (fresh?.avatar) {
//                         updateUser({ avatar: fresh.avatar });
//                         setProfileImage({ uri: fresh.avatar });
//                     }
//                 } catch (e) {
