                        ...
                        <View key={idx} style={{ width }} className="px-6 pt-14">
                            <View className="items-center">
                                ...
                                <View className="flex-row gap-2 mt-10">
                                    <View className={`${page === 0 ? 'bg-primary' : 'bg-gray-300'} h-2 w-2 rounded-full`} />
                                    <View className={`${page === 1 ? 'bg-primary' : 'bg-gray-300'} h-2 w-2 rounded-full`} />
                                </View>

                                <View className='max-w-[360px] w-full'>
                                    <Text className="max-w-xs w-full mx-auto text-xl font-semibold text-center text-black mt-8 px-2">{s.title}</Text>
                                    <Text className="text-base text-black-400 text-center mt-4 px-2">{s.description}</Text>
                                </View>
