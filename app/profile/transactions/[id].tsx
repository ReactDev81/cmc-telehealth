...
const TransactionDetails = () => {
    return (
        <ScrollView className="flex-1 p-5 bg-white">
            ...
            <View className="border border-[#EDEDED] rounded-xl mt-7 py-1 px-4">

                <View className="flex-row items-center justify-between py-4 border-b border-[#EDEDED]">
            ...
            <View className="mt-7">
                ...
                <TouchableOpacity className="border border-gray rounded-xl p-4 mt-5 flex-row items-center justify-between gap-x-2.5">
                    
                    <View className="flex-row items-center justify-between gap-x-2.5">
                        <View className="w-9 h-9 items-center justify-center bg-[#EDEDED] rounded">
