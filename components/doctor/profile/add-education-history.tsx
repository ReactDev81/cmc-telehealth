...
const AddNewEducationHistory = ({
    ...
    const { mutate: updateProfile, isPending } = useUpdateDoctorProfile(doctorID, "education_info");
    ...
    const onSubmit = (data: EducationHistoryFormData) => {
        ...
        updateProfile(payload, {
            ...
            onError: (error: any) => {
                console.log(error);
                Alert.alert("Error", error?.response?.data?.message || "Something went wrong while saving education");
            }
        });
    }
