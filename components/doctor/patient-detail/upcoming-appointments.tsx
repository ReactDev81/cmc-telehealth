...
const UpcomingAppointment = ({ time, date, mode } : props ) => {
    return(
        <View className="border border-black-300 rounded-xl p-4 mt-5">
            <View className="flex-row justify-between">
                <Text className="text-lg font-medium text-black">Upcoming Appointments</Text>
                <Text className={`text-xs text-info bg-info-400 capitalize font-medium w-fit p-2 rounded-md`}>
                    Scheduled
                </Text>
            </View>
